...
- **Patching fails with an error or patched app crashes**:
  - Make sure Nexora Manager is up to date by following [🔄 Updating Nexora Manager](2_4_updating.md)
...
- **Patches fail to load**: The selected file is not using the source API format supported by Nexora Manager or the remote URL is not reachable.
...
Learn how to build Nexora Manager from source.
